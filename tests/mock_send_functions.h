...
{
    bmcl::Option<Error> apply_log(const LogEntry& entry, std::size_t entry_idx) override { return bmcl::None; }
    ...
    bmcl::Option<Error> push_back(const LogEntry& entry, std::size_t entry_idx) override { return bmcl::None; }
    void pop_front(const LogEntry& entry, std::size_t entry_idx) override {}
